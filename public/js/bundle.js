...
var loadAllTour = function loadAllTour(res, alertMsg) {
  if (res.data.status === 'success') {
    (0, _alerts.showAlert)('success', alertMsg);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', _context.t0.response.data.message || 'User already exists!');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2hhcmxlc21hcmlnYSIsImEiOiJja2VmdXJobjIwMDBxMnVxaTRpejBjamlwIn0.4TigzozoaTNMXalbwZI9eA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/charlesmariga/ckeg3l6612gwe19me5i0o9mg9',
    scrollZoom: false
  });
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (updatedUser.data.status === 'success') (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully!"));
            _context.next = 11;
            break;
...
var stripe = Stripe('pk_test_oh6Vt40LZ2XlQLmCnWhUrdm200Q4jay5aK');
...
var form = document.querySelector('.form--login') || document.querySelector('.form--sign-up');
